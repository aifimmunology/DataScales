...
JOBS=(
    ...
    "health_atlas   dense(w=1)|pixi run datascale convert-h5ad --input ./data/human_immune_health_atlas_other.h5ad --output $TMP_ZARR --overwrite --x-storage dense --cpus 1"
    "health_atlas   dense(w=2)|pixi run datascale convert-h5ad --input ./data/human_immune_health_atlas_other.h5ad --output $TMP_ZARR --overwrite --x-storage dense --cpus 2"
    "health_atlas   dense(w=4)|pixi run datascale convert-h5ad --input ./data/human_immune_health_atlas_other.h5ad --output $TMP_ZARR --overwrite --x-storage dense --cpus 4"
    "health_atlas   dense(w=8)|pixi run datascale convert-h5ad --input ./data/human_immune_health_atlas_other.h5ad --output $TMP_ZARR --overwrite --x-storage dense --cpus 8"
